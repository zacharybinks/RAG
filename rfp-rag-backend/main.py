...
# --- LangChain Imports ---
# **FIX**: Added the missing PyPDFLoader import
...
s3_client = boto3.client("s3") if APP_ENV == "production" else None

# --- App Setup ---
PROJECTS_DIRECTORY = "/tmp/rfp_projects" if APP_ENV == "production" else "./rfp_projects"
DB_DIRECTORY = "/tmp/chroma_db" if APP_ENV == "production" else "./chroma_db"
os.makedirs(PROJECTS_DIRECTORY, exist_ok=True)
os.makedirs(DB_DIRECTORY, exist_ok=True)

app = FastAPI(title="RFP RAG System Backend - Final Corrected")
